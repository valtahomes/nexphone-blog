...
with both hands in someone's hair. Your phone rings in your pocket.

You can't take it. It rings four times and goes to voicemail. The caller doesn't leave one — almost
nobody does any more — and by the time you've washed up and checked, they've already called the next
name on the list and booked with them.
...
You also choose how it sounds. Give it your business's name and pick from 22 voices across American,
British and Australian accents. It introduces itself the way you would, so callers hear your business
rather than a robot reading a script off a card.

### It knows what it shouldn't answer

An AI that always has an answer is worse than no AI at all. A caller with a complaint, a legal
...
Some owners want the AI on every call. Others want their team to get first crack, with the AI taking
...
![A small crew sharing one business line](https://nexphone.ai/images/crew-two-tradespeople.jpg)

Under the AI is a genuine business phone system, because sooner or later you need one.

You get your own greeting and a menu of up to five options with sub-menus, each doing what you choose:
ring a person, take a voicemail, play your hours, or route deeper. A one-person shop sounds like a
real operation, and callers land where they meant to instead of in a maze.

When calls ring your team they ring **everyone on shift at once** — app or phone — and whoever picks
up first takes it. No "who's grabbing this?", nobody left holding. Who's on shift is a toggle or a
weekly schedule, and calls skip anyone who's off. If everyone's out it still falls to you before
voicemail, so nothing drops unhandled.

Anything unanswered rolls to voicemail with your own greeting, recorded and transcribed. A missed call
is still a message you can act on.

## Your number, your customers, your data

![A field-service owner handing out a business number instead of a personal cell](https://nexphone.ai/images/feature-own-cell.webp)

Using your personal cell as your business line creates two problems, and both get expensive later.
...
The next call gets answered whether or not you're free to take it — which, if you've read this far, is
probably the reason you were thinking about your phone in the first place.
